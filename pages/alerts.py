    ...
    for _, row in high_risk.head(20).iterrows():
        ...
        <div style="background:#0a0f1e; border:1px solid #1a2540; border-left:4px solid #ff4560;
          ...
          <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:8px; margin-bottom:10px;">
            <div style="background:#050810; border-radius:6px; padding:8px; text-align:center;">
              <div style="font-family:Share Tech Mono,monospace; font-size:0.7rem; color:#00f5a0;">RF</div>
              <div style="font-family:Rajdhani,sans-serif; font-weight:700; color:#00f5a0;">{int(row['rf_score']*100)}%</div>
            </div>
            <div style="background:#050810; border-radius:6px; padding:8px; text-align:center;">
              <div style="font-family:Share Tech Mono,monospace; font-size:0.7rem; color:#00c8ff;">LR</div>
              <div style="font-family:Rajdhani,sans-serif; font-weight:700; color:#00c8ff;">{int(row['lr_score']*100)}%</div>
            </div>
            <div style="background:#050810; border-radius:6px; padding:8px; text-align:center;">
              <div style="font-family:Share Tech Mono,monospace; font-size:0.7rem; color:#a855f7;">SVM</div>
              <div style="font-family:Rajdhani,sans-serif; font-weight:700; color:#a855f7;">{int(row['svm_score']*100)}%</div>
            </div>
            <div style="background:#050810; border-radius:6px; padding:8px; text-align:center;">
              <div style="font-family:Share Tech Mono,monospace; font-size:0.7rem; color:#ff4560;">Sessions</div>
              <div style="font-family:Rajdhani,sans-serif; font-weight:700; color:#ff4560;">{row['session_count']}</div>
            </div>
          </div>
